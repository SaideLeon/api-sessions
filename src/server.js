...
class App {
  ...
  routes() {
    ...
    this.app.use(`${apiV1}/api-docs`, swaggerUi.serve, swaggerUi.setup(swaggerDocument));
    ...
    this.app.use(`${apiV1}/sessions`, getQrCode(this.sessions));
...
📝 API Docs: http://localhost:${PORT}/api/v1/api-docs
🔌 WebSocket enabled
          `);
          resolve(this.server);
        });
